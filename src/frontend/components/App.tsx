...
import { ScenarioManagementPage } from "./ScenarioManagement/ScenarioManagementPage";
import { Stats } from "../types";

type Page = "endpoints" | "scenarios";

export const App: React.FC = () => {
  const [currentPage, setCurrentPage] = useState<Page>("endpoints");
